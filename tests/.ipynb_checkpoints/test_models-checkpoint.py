...
from src.models import make_preprocessor, make_pipe, make_lgbm_l1_objective
...
def test_make_preprocessor_collapses_categoricals(toy):
    ...
    # target encoding collapses each categorical to a single column
...
def test_make_lgbm_l1_objective_returns_valid_mae(toy):
    ...
    assert mae >= 0.0  # it is a mean absolute error
